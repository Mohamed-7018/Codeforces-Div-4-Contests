...
void solve() {
 ...
 F(i,0,n) {
     ...
     if(y=="01") ans_01.pb(x);
     else if(y=="10") ans_10.pb(x);
     else if(y=="11") ans_11.pb(x);
 ...
 SORT(ans_11);
 SORT(ans_10);
 if(sz(ans_01) >= 1  && sz(ans_10)>=1 ){
     if( sz(ans_11)>=1) {
         cout << min(ans_01[0] + ans_10 [0], ans_11[0])<<nl;
     }
     else if(sz(ans_11) ==0) {
         cout << ans_01[0] + ans_10[0] << nl;
     }
 }
 else if(sz(ans_11)>=1) cout << ans_11[0]<<nl;
 else   cout << -1 <<nl;
}
// 111
//101
